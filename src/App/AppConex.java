    ...
    private static void pantallaEventos(Scanner scanner, Integer idCliente) {
        ...
        while (!salirEventos) {
            ...
            try {
                ...
                System.out.println("┌──────────────────────────────────────────────────────────────────────┐");
                System.out.println("│  CARTELERA ACTUAL DE EVENTOS                                         │");
                System.out.println("└──────────────────────────────────────────────────────────────────────┘\n");
                            ...
                            if (opcDetalle == 1 && idCliente != null) {
                                ...
                                try {
                                    ...
                                    try (PreparedStatement pstBusqueda = conxTransaccion.prepareStatement(sqlBusqueda)) {
                                        pstBusqueda.setString(1, eventoElegido.getId());
                                    ...
                                    if (conxTransaccion != null) {
                                        try { 
                                            conxTransaccion.setAutoCommit(true); // Restauramos el comportamiento normal
